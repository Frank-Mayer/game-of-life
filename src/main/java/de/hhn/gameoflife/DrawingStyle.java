...
public enum DrawingStyle {
  ...
  BLINKER("Blinker", DrawingStyleCategory.OSCILLATORS, new Boolean[][]{
      {false, false, false, false, false},
      {false, false, false, false, false},
  ...
  TOAD("Toad", DrawingStyleCategory.OSCILLATORS, new Boolean[][]{
      {false, false, false, false, false, false},
      {false, false, false, true, false, false},
      {false, true, false, false, true, false},
      {false, true, false, false, true, false},
  ...
  BEACON("Beacon", DrawingStyleCategory.OSCILLATORS, new Boolean[][]{
      {false, false, false, false, false, false},
  ...
  PULSAR("Pulsar", DrawingStyleCategory.OSCILLATORS, new Boolean[][]{
  ...
  PENTADECATHLON("Pentadecathlon", DrawingStyleCategory.OSCILLATORS, new Boolean[][]{
  ...
  GLIDER("Glider", DrawingStyleCategory.SPACESHIPS, new Boolean[][]{
      {false, false, false, false, false},
  ...
  LWSS("LWSS", DrawingStyleCategory.SPACESHIPS, new Boolean[][]{
  ...
  MWSS("MWSS", DrawingStyleCategory.SPACESHIPS, new Boolean[][]{
  ...
  //Middle-Weighted-Spaceship
  HWSS("MWSS", DrawingStyleCategory.SPACESHIPS, new Boolean[][]{
